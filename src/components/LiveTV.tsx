...
const LiveTV: React.FC<LiveTVProps> = ({ onChannelSelect }) => {
  ...
  const channels: Channel[] = [
    ...
    },
    {
      ...
      "streamUrl": "http://188.241.219.157/live/KVSingh/KVSingh/274122.ts?token=ShJdY2ZmQQNHCmMZCDZXUh9GSHAWGFMD.ZDsGQVN.",
      "category": "Sports"
    }
  ];
